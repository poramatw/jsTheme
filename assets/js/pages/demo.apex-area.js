...
(chart = new ApexCharts(
  ...
  $(document).ready(function () {
    var e = ["#6c757d"],
      t = $("#area-chart-datetime").data("colors");
    t && (e = t.split(","));
    var a = {
        annotations: {
          yaxis: [
    ...
    document
      ...
      document.querySelector("#all").addEventListener("click", function (e) {
        r(e), o.updateOptions({ xaxis: { min: void 0, max: void 0 } });
      }),
...
options = {
  ...
  responsive: [
    { breakpoint: 600, options: { chart: { toolbar: { show: !1 } } } },
  ],
};
...
(dataColors = $("#area-timeSeries").data("colors")) &&
  (colors = dataColors.split(","));
options = {
  chart: { type: "area", stacked: !1, height: 380, zoom: { enabled: !1 } },
  ...
  title: { text: "Irregular Data in Time Series", align: "left", offsetX: 0 },
  tooltip: {
    shared: !0,
    y: {
      formatter: function (e) {
  ...
  legend: { position: "top", horizontalAlign: "center", offsetX: -10 },
  grid: {
    row: { colors: ["transparent", "transparent"], opacity: 0.2 },
    borderColor: "#f1f3fa",
  },
